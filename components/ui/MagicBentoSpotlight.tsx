...
const DEFAULT_GLOW_COLOR = '0, 102, 255';
...
const updateCardGlowProperties = (
    card: HTMLElement, mouseX: number, mouseY: number,
...
interface MagicBentoSpotlightProps {
    /** Ref to the grid/section container */
...
/**
 * GlobalSpotlight from original reactbits MagicBento source.
 * Queries `.magic-bento-card` inside `.bento-section`.
 */
