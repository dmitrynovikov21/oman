...
print("\n[1/5] Updating next.config.js to skip type checking...")
...
stdin, stdout, stderr = ssh.exec_command(f"cat > {DEPLOY_DIR}/app/next.config.js << 'NEXTCFG'\n{next_config}\nNEXTCFG")
print("  [OK] next.config.js updated")
...
with open("final_final_build.log", "w", encoding="utf-8") as f:
    f.write(output)
